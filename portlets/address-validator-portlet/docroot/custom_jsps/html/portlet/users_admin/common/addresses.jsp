	...
	%>
		...
		<div class="lfr-form-row">
			<div class="row-fields">
				...
				<%@ include file="/html/portlet/users_admin/common/address_validation.jspf" %> <%--custom rivet --%>
			</div>
		</div>
        ...
        'rivet-custom' : {
            ...
            modules : {
                'rivet-custom-dynamic-select': {
                        path: 'rivet_custom_dynamic_select.js',
                        requires: [
                            'aui-base'
                        ]
                },
...
<aui:script use="liferay-auto-fields,rivet-custom-dynamic-select"><%-- custom rivet --%>
	Liferay.once(
