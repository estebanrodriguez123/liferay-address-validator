...
/**
 * Portlet implementation class AddressValidator
 */
public class AddressValidatorPortlet extends MVCPortlet {
    ...
    private Address getAddressFromRequest(PortletRequest request, PortletResponse response) throws PortalException,
        SystemException {
